...
object MockData {
	...
	val mockUiEntity = OrganizationUiEntity(
		id = 1,
	...
	val mockUiEntityList = listOf(
		mockUiEntity,
		mockUiEntity.copy(id = 2, rating = 5f),
		mockUiEntity.copy(id = 3, isFavorite = true),
		mockUiEntity.copy(id = 4, rating = 0f),
		mockUiEntity.copy(id = 5, isFavorite = true),
		mockUiEntity.copy(id = 6, rating = 1f),
		mockUiEntity.copy(id = 7, isFavorite = true, rating = 2f),
	)

	val mockDetailUiEntity = OrganizationDetailUiEntity(
		id = 0,
		name = "Restaurant Name",
